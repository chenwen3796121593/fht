...
【定论】报告第一行必须是极简定论，格式固定为：方向 | 一句话策略 | 关键位。例："偏多 | 拥塞层龙头逢回调配置，放量破位则减仓 | 龙头区间 120-135"。要求：方向只能是"偏多/偏空/震荡"三选一；一句话策略≤20字、普通投资者一看就懂；关键位给具体价位区间（个股给支撑/阻力，主题给龙头或板块关键位，无明确价位可写核心参考区间）。随后才是详细分析。
